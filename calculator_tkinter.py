...
clear = Button(btns_frame, text="C", fg="black", width=38, height=3, bd=0, cursor="hand2",
...
multiply = Button(btns_frame, text='*', fg='black', width=10, height=3, bd=0, bg='#FFA500', cursor='hand2',
...
add = Button(btns_frame, text='+', fg='black', width=10, height=3, bd=0, bg='#FFA500', cursor='hand2',
                command=lambda: btn_click('+')).grid(row=3, column=3, padx=1, pady=1)

zero = Button(btns_frame, text='0', fg='black', width=24, height=3, bd=0, bg='#eee', cursor='hand2',
...
equal = Button(btns_frame, text='=', fg='black', width=10, height=3, bd=0, bg='#eee', cursor='hand2',
